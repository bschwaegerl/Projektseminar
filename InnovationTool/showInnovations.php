	...
	<body>
		<?php
			...
			if(isset($_POST['hinzufügen'])){
				...
				$insertInnoFound = "INSERT INTO _innovation_found (word) SELECT * FROM (SELECT '$_POST[wort]') as tmp WHERE NOT EXISTS (SELECT * FROM _innovation_found where word = '$_POST[wort]') LIMIT 1";
